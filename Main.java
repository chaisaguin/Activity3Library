...
class Main {
    public static void main(String[] args) {
        Book book1 = new Book("Tokyo Ghoul", "Sui Ishida",2018);
        Book book2 = new Book("OCA Java SE 8", "Kathy Sierra", 2014);

        DVD dvd1 = new DVD("Starwars", "George Lucas", 1977);
        DVD dvd2 = new DVD("Noli Me Tangere", "Jose Rizal", 1990);

        Student student = new Student("Alice", 1001);
        Student student2 = new Student("Kaneki", 1002);
        Teacher teacher = new Teacher("Smith", 2001);
